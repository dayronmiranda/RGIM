/*
  RGIM Single Page Prototype - Modular Version
...
;(function(){
  ...
  let els = {} // Will be populated after components load
  ...
  // Initialize elements after components are loaded
  function initElements() {
    els = {
      routes: {
        home: document.getElementById('home-component'),
        store: document.getElementById('store-component'),
        faq: document.getElementById('faq-component'),
        about: document.getElementById('about-component'),
        admin: document.getElementById('admin-component')
      },
  ...
  function openProductModal(p){
    ...
    overlay.querySelector('[data-add]').onclick = ()=> { addToCart(p.id); overlay.remove() }
  }
